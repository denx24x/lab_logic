...
happyExpList = Happy_Data_Array.listArray (0,35) ([16912,16,0,448,16912,0,1472,16912,16912,16912,448,64,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseExpr","Expr","IDENT","NOT","AND","OR","IMPL","LEFTP","RIGHTP","NEXTLINE","PROOVE","SEP","FALSE","%eof"]
...
happyReduction_1 (HappyTerminal (Ident happy_var_1))
	 =  HappyAbsSyn4
		 (Var happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	Ident happy_dollar_dollar -> cont 5;
	NotT -> cont 6;
	AndT -> cont 7;
	OrT -> cont 8;
	ImplT -> cont 9;
