...
happyExpList = Happy_Data_Array.listArray (0,39) ([2240,4480,0,14337,4,6144,12289,2,0,23,0,35,70,140,280,560,896,0,3584,1024,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseExpr","Line","Context","Expr","IDENT","NOT","AND","OR","IMPL","LEFTP","RIGHTP","NEXTLINE","PROOVE","SEP","%eof"]
...
action_8 (13) = happyShift action_20
...
happyReduction_1 (HappyAbsSyn6  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn4
		 (Line (Context happy_var_1) happy_var_3
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	Ident happy_dollar_dollar -> cont 7;
	NotT -> cont 8;
	AndT -> cont 9;
	OrT -> cont 10;
	ImplT -> cont 11;
